...
def load_models():
    ...
    if model_source == "mock":
        models["price_model"] = {"version_hash": "mock-123", "trained_at": "2026-02-20", "training_rows": 0}
        models["conversion_model"] = {"version_hash": "mock-456", "trained_at": "2026-02-20", "training_rows": 0}
    else:
        try:
...
def health():
    ...
    return {
        "status": "ok",
        "models": models.get("meta", "Not loaded")
    }
