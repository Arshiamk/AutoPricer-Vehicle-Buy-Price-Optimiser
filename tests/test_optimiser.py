...
def test_compute_ev_tail_penalty_reduces_ev():
    ev_no_penalty = compute_ev(
        offer=6500, p_win=0.5, e_sale=8000, e_costs=500, price_q10=7000, risk_lambda=0.0
    )
    ev_with_penalty = compute_ev(
        offer=6500, p_win=0.5, e_sale=8000, e_costs=500, price_q10=6000, risk_lambda=1.0
    )
...
def test_optimise_offer_valid_range():
    ...
    result = optimise_offer(
        e_sale=10000, price_q10=8000, e_costs=500, predict_p_win_func=lambda off: 0.5
    )
...
def test_optimise_offer_no_profitable_margin():
    result = optimise_offer(
        e_sale=2000, price_q10=1800, e_costs=2000, predict_p_win_func=lambda off: 0.8
    )
